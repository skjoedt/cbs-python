...
standard_menu("CBSCO","(courses.html,'CBS Courses')","(test, 'test')","Python for Bioinformatics");
?>
...
<h1 id="getting-course-material">Getting course material</h1>
Short version:
<ol>
    <li>
Install git on linux/Mac or the <a href="http://http://windows.github.com/">github tool</a> on Windows
</li>
    <li>
Clone the cbs-python repository at <a href="https://github.com/skjoedt/cbs-python/">github</a>
</li>
    <li>
Link your Ipython Notebook to this folder
</li>
</ol>
...
<p>During the course I will be using notebooks for lecture notes. A preview is shown below. The idea is that you can get these lecture notes and you can make your own notes on top of them if you want using IPython Notebook. The instructions for setting up IPython will follow in the first lecture.</p>
<img src="images/notebook_ex.png" width="800px" />
<h3 id="exercises">Exercises</h3>
<p>Some exercises will also be made in notebooks with explaining text and figures encapsulating code blocks that are either partially filled out or empty. The exercise will be for you to fill out these code blocks for the problems to be solved. Some exercises will involve loading data from files that should be put in the correct directories relative to the exercises. Because this is a pilot course still under development, some of the exercise material will be made available during the semester.</p>
<h2 id="getting-the-latest-versions-of-lecture-notes-and-exercises">Getting the latest versions of lecture notes and exercises</h2>
<p>Since the course is still under development lecture notes and exercises are expected to be updated during the semester. To avoid any problems with missing data files or outdated notes I have set up a github repository, which is nothing more than a online folder that you can syncronize to. This way you start each lecture with updating your local files with any changes that might have been made.</p>
<p>To do all this as painless as possible we should start out by setting everything up for the rest of the course.</p>
...
<p>Go to the section that covers your system.</p>
<h3 id="mac">MAC</h3>
<p>All you need is git. Go to http://git-scm.com/download/mac and downlaod the dmg installation file. Once downloaded, open it and open the git installer inside. Follow the instructions for installing git.</p>
<p>Once installed open a terminal and navigate to the document folder where you want the course material to be downloaded, eg.</p>
<p><cb>cd /Users/christian/Documents/courses/</cb></p>
<p>now clone the cbs-python github</p>
<p><cb>git clone https://github.com/skjoedt/cbs-python.git</cb></p>
<p>If things worked out as expected you should have a folder called <cb>cbs-python</cb> from where you called the <cb>git clone</cb> command. This folder will store all course materials and exercises as they are updated during the semester.</p>
<h4 id="updating-your-local-files">Updating your local files</h4>
<p>Before each lectures you should update the files to the newest versions. This is done by simply running</p>
<p><cb>git checkout -f master</cb></p>
<p>and</p>
<p><cb>git pull origin master</cb></p>
<p>from the cbs-python directory.</p>
<h3 id="linux">Linux</h3>
<p>All you need is git. If you are running ubuntu or debian you get it by typing</p>
<p><cb>sudo apt-get install git</cb></p>
<p>if you are running fedora you can type</p>
<p><cb>sudo yum install git</cb></p>
<p>Now you need to choose a directory to store the course materials, eg <cb>/home/christian/Documents/courses/</cb>. Navigate to the folder:</p>
<p><cb>cd /home/christian/Documents/courses</cb></p>
<p>now clone the cbs-python github</p>
<p><cb>git clone https://github.com/skjoedt/cbs-python.git</cb></p>
<p>If things worked out as expected you should have a folder called <cb>cbs-python</cb> from where you called the <cb>git clone</cb> command. This folder will store all course materials and exercises as they are updated during the semester.</p>
<h4 id="updating-your-local-files-1">Updating your local files</h4>
<p>Before each lectures you should update the files to the newest versions. This is done by simply running</p>
<p><cb>git checkout -f master</cb></p>
<p>and</p>
<p><cb>git pull origin master</cb></p>
...
<p>Windows users should download and install the github tool from http://windows.github.com/. Go to the link and click the green download link in the upper right corner.</p>
<img src="images/github_win_1.png" width="800px" />
<p>After the download is complete open the installer and follow the instructions on the screen until you see this window.</p>
<center>
<img src="images/github_win_2.png" width="500px" />
</center>
<br /><br />
<p>Now that the github tool is installed open the Git Shell <img src="images/gitshell.png" /> icon on your desktop. <br /><br /></p>
<p>In the terminal window type in:<br /><br /></p>
<p><cb>git clone https://github.com/skjoedt/cbs-python.git</cb><br /><br /></p>
<center>
<img src="images/gitshell_clone.png" width="500px" />
</center>

<p>You should now have a folder in your Documents called GitHub. Inside you will find the repository with the course material.</p>
<img src="images/github_win_6.png" width="800px" />
<h4 id="updating-the-local-files">Updating the local files</h4>
<p>To update the local files open the github shell <img src="images/gitshell.png" /> and navigate to the cbs-python directory:</p>
<p><cb>cd cbs-python</cb></p>
<p>Now run these two commands to update your local files:</p>
<p><cb>git checkout -f master</cb><br /> and<br /> <cb>git pull origin master</cb><br /><br  /></p>
<center>
<img src="images/gitshell_upd.png" width="500px" />
</center>
