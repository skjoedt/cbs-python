...
standard_head("Getting Course Material");
...
standard_menu("CBSCO","(courses/27624/,'Python for Bioinformatics')","Getting Course Material");
?>
...
<hr />
<img src="http://python.org/images/python-logo.gif" /><br />
...
<p>You will early on be confused about python being distributed in two different versions; Python2 and Python3. You will not find alot of differences between the two versions in your python journey, but one deserves to be highlighted already at this stage:</p>
<blockquote>
<p>Some third-party <em>modules</em> (packages) are not supported in Python3</p>
</blockquote>
<p>This means that if you want to use external modules made by others, they may not be compatible with your current Python3 code. Most modules you will find describes what Python version(s) they support.</p>
<blockquote>
<p><b><i>To avoid running into these issues during the course we will only be using Python2.</i></b></p>
</blockquote>
<hr />
<img src="http://ipython.org/ipython-doc/stable/_static/logo.png" height="40px">
<p>IPython provides a rich toolkit to help you make the most out of using Python interactively. First of all it comes with a rich and powerful version of the orignial python prompt with a lot of interactive features that will become clearer later in the course.</p>
<p>IPython also includes IPython Notebook which is a web-based python environment that is full of features. It offers a journal like perspective to your python coding and is very helpful for getting hands on python and will be used extensively in the first lectures. In fact, this text was written in IPython Notebook.</p>
<p>Check out some of the stuffs that has been done in this journal like editor <a href="http://nbviewer.ipython.org/" target="_blank">here</a>.</p>
<hr />
</div>
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="windows">Windows</h2>
<h3 id="python">Python</h3>
Windows doesn't come with python preinstalled. You need to download and install it:
<ol>
    <li>
Go to http://www.python.org/download/ and download the latest Python releases for Python2 for your system. Here are direct links to the recent ones:
</li>
    <ul>
        <li> 
[<a href="http://www.python.org/ftp/python/2.7.5/python-2.7.5.msi">Python2 32-bit</a>]
</li>
        <li> 
[<a href="http://www.python.org/ftp/python/2.7.5/python-2.7.5.amd64.msi" target="_blank">Python2 64-bit</a>]
</li>
    </ul>
    <li>
Run the installer and follow the install wizard with default settings.
</li>
    <li>
Once installed test the python program by running the shortcut <i> Python (command line) in start menu</i> and you should see something like this:
</li>
    
<img src="images/py_install1.jpg"> <br> This is the python prompt that you can use to type in python commands. We will not be using this prompt directly in the course we but do need the python enterpreter behind it.
</ol>

<h3 id="ipython-and-extras">IPython and extras</h3>
<p>Now that we have python set up on the computer we can use a small tool written in python to fetch the rest that we need.</p>
<ol>
    <li>
First, download <a href="https://bitbucket.org/pypa/setuptools/raw/bootstrap/ez_setup.py" target="_blank">this script</a> to your desktop.
</li>
    <li>
Run the script (double click) and a command line prompt will appear shortly. What the script does is unpacking an executable file <i>easy_install.exe</i> into your Python script folder.
</li>
    <li>
Now open the run command by holding down <kbd><img id="wds" src="images/wds.png" height=10px></kbd> while pressing <kbd>R</kbd>.
</li>
    <li>
Type in <cb>cmd</cb> and hit Enter. This will open the command line prompt.
</li>
    <li>
Type in <cb>cd C:/Python27/Scripts</cb> to navigate to this folder.
</li>
    <p>
<b>(Note: Use backslash instead of slash in the path).</b>
</p>
    
<img src="images/py_install2.jpg">
<li>
Now run the following commands to start installing the extra python modules that we need for the course:
</li>
    
<cb>easy_install.exe mathlib</cb><br /> <cb>easy_install.exe numpy</cb><br /> <cb>easy_install.exe scipy</cb><br /> <cb>easy_install.exe pandas</cb><br /> <cb>easy_install.exe tornado</cb><br /> <cb>easy_install.exe pyzmq</cb><br /> <cb>easy_install.exe pip</cb><br />
<li>
We will use pip to install IPython, since at this time easy_install does not contain the latest version. This is done by running:
</li>
    
<cb>pip.exe install ipython</cb><br />
<li>
Now all we need is to create a shortcut to IPython Notebook. On your Desktop (or anywere you like) right click and select <em>New</em> and then <em>Shortcut</em>.
</li>
    <li>
In the shortcut path type in <cb>C:/Python27/Scripts/ipython.exe notebook --notebook-dir=&quot;C:/Documents and Settings/christian/My Documents/GitHub/cbs-python/notebooks&quot;</cb>
</li>
    <p>
<b>Note: You should set the path to whereever your course material is located - Remember: Use backslash!</b>
</p>
    
<img src="images/py_install3.jpg">
<li>
Run the program from the newly created shortcut and celebrate the success!
</li>
    
<img src="images/py_install4.jpg" width="700px">
</ol>
...
<h2 id="mac">MAC</h2>
<h3 id="python">Python</h3>
<p>Python comes pre-installed on Mac OS X, but due to Apple's release cycle, it's often one or even two years old. The overwhelming recommendation of the &quot;MacPython&quot; community is to upgrade your Python by downloading and installing a newer version from the Python standard release page.</p>
<ol>
    <li>
Download the latest Python2 release for your system to your desktop:
    ...
    <ul>
        <li> 
[<a href="http://www.python.org/ftp/python/2.7.5/python-2.7.5-macosx10.3.dmg" target="_blank">Python2 32-bit</a> (MacOS X 10.3+)]
</li>
        <li> 
[<a href="http://www.python.org/ftp/python/2.7.5/python-2.7.5-macosx10.6.dmg" target="_blank">Python2 64-bit</a> (MacOS X 10.6+)]
</li>
    </ul>
    <li>
Open a terminal: <i>/Applications/Utilities/Terminal</i>
</li>
    <li>
Navigate to Desktop by typing <cb>cd ~/Desktop/</cb>
</li>
    <li>
Install Python2 by running either
</li>
    
<cb>hdiutil mount python-2.7.5-macosx10.3.dmg</cb> for 32-bit, or<br /> <cb>hdiutil mount python-2.7.5-macosx10.6.dmg</cb> for 64-bit.<br/> and then, <br /> <cb>sudo installer -pkg &quot;/Volumes/Python 2.7.5/Python.mpkg&quot; -target /</cb>
</ol>
<h3 id="ipython-and-extras">IPython and extras</h3>
<p>The program <i>easy_install</i> comes with python and can be used to install additional Python2 packages:</p>
<ul>
<cb>sudo easy_install numpy</cb><br /> <cb>sudo easy_install scipy</cb><br /> <cb>sudo easy_install pandas</cb><br /> <cb>sudo easy_install tornado</cb><br /> <cb>sudo easy_install pyzmq</cb><br /> <cb>sudo easy_install pip</cb><br />
</ul>

<p>Unfortunately easy_install does not contain the latest version of IPython that we will use in the course. Therefore use the newly installed <i>pip</i> to get it: <cb>sudo pip install ipython</cb><br /></p>
<p>Now, if everything went okay you should be able to run <cb>ipython notebook</cb> and see the following window:</p>
<img src="images/py_install5.jpg", width="700px">
<p>To access the course material, you have to run the <cb>ipython notebook</cb> command from the notebook directory.</p>
<hr />
</div>
<div class="text_cell_render border-box-sizing rendered_html">
<h2 id="linux">Linux</h2>
<h3 id="python">Python</h3>
<p>Python comes installed with all linux distributions worth mentioning.</p>
<h3 id="ipython-and-extras">IPython and extras</h3>
<p>In Ubuntu/Debian systems run in the terminal: <br /></p>
<p><cb>sudo apt-get install python-pandas python-matplotlib python-numpy python-pip python-zmq python-tornado</cb><br /><br /></p>
<p>In Fedora systems run in the terminal:<br /></p>
<p><cb>sudo yum install python-pandas python-matplotlib python-numpy python-pip python-zmq python-tornado</cb><br /><br /></p>
<p>Now install IPython using pip: <br /></p>
<p><cb>sudo pip install ipython</cb><br /><br /></p>
<p>Now check that it works by running <cb>ipython notebook</cb> in your terminal. You should see the following browser window popping up:<br /></p>
<img src="images/py_install6.jpg", width="700px">
<p>To access the course material and exercises you have to run the <cb>ipython notebook</cb> command from the notebook directory.</p>
</div>
<div class="text_cell_render border-box-sizing rendered_html">
<hr />
<h2 id="final-remarks">Final remarks</h2>
<p>If you have any questions or problems during installation stop by my office 060 in 208 and I will try to help you out.</p>
</div>
